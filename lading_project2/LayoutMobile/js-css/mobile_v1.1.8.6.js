...
function quickOrder_checkOut() {
    $(".btnQuickOrder").off();
    $(".btnQuickOrder").click(function () {
        var u = $(".btnQuickOrder").hasClass("disabled") || $(".btnQuickOrder").hasClass("btn-outstock"), i, n, t, r;
        u || (i = $(this).attr("data-sku"),
            n = $("#colorOptions .selected").attr("data-id"),
            n = n ? n : -1,
            t = cartGetCookie(),
            t ? (r = t.findIndex(n => n.sku == i),
                n && (r = t.findIndex(t => t.sku == i && t.color == n)),
                r >= 0 ? t[r].number++ : (t.push({
                    sku: i,
                    number: 1,
                    color: n
                }),
                    flyToElement(this, $("#cart-total")))) : t.push({
                        sku: i,
                        number: 1,
                        color: n
                    }),
...
function jssor_free_drag(n, t) {
    function i() {
        var n = sliderContent.$Elmt.parentNode.clientWidth
            , t = sliderContent.$OriginalHeight();
        n ? (console.log(n + "," + t),
            sliderContent.$ScaleSize(n, t)) : window.setTimeout(i, 30)
    }
    var r = {
        $SlideWidth: t,
        $FillMode: 4,
    ...
    sliderContent = new $JssorSlider$(n, r);
    i()
}
var sanitizeHTML, RECAPTCHA_API_KEY, specsHeight, setProductContentHeighWithSpecs;
!function (n, t) {
    "use strict";
    ...
    function (n) {
        ...
        i.prototype = {
            ...
            suggest: function () {
                ...
                var t = this, u = t.options, s = u.groupBy, a = u.formatResult, i = t.getQuery(t.currentValue), h = t.classes.suggestion, v = t.classes.selected, f = n(t.suggestionsContainer), y = n(t.noSuggestionsContainer), c = u.beforeRender, e = "", l = u.showLink, o, p = function (n) {
                    var t = n.data[s];
                    return o === t ? "" : (o = t,
                        u.formatGroup(n, o))
                };
                if (i = sanitizeHTML(i),
                    u.triggerSelectOnValidInput && t.isExactMatch(i)) {
                    t.select(0);
                    return
                }
                r = i.toLowerCase();
                ...
                t.fixPosition();
                f.show();
                u.autoSelectFirst && (t.selectedIndex = 0,
                    f.scrollTop(0),
                    f.children("." + h).first().addClass(v));
                t.visible = !0;
                t.findBestHint()
            },
...
$(document).ready(function () {
    ...
    $(".product-shop .check-stock .city .button").click(function () {
        $(".product-shop .check-stock .city .list").show()
    });
    $(".product-shop .check-stock .city .list ul li").click(function () {
        $(".product-shop .check-stock .city .list").hide()
    });
    $("#kwd").autocomplete({
...
imagePreview_init = function () {
    function t() {
        ...
        i ? n.$ScaleWidth(i) : window.setTimeout(t, 30)
    }
    var r = {
        $AutoPlay: !0,
        $SlideDuration: 500,
    ...
    $("#colorOptions > div").click(function () {
        ...
        n.$GoTo(s);
        n.$Pause();
        var o = $(this).attr("data-bestPrice")
            , l = $(this).attr("data-lastPrice")
            , a = $(this).attr("data-pricenote")
            , v = $(this).attr("data-hotsale")
            , i = "<strong>" + o + "<\/strong>";
        l != "" && (i += "<i><strike>" + l + "<\/strike><\/i>");
        i += " <i> | Giá đã bao gồm 10% VAT<\/i>";
        i += v;
        a != "" && (i += "<i>" + a + "");
        $(".current-product-price").html(i);
        f = $(".renewPrice").attr("data-val");
        f && (h = parseInt(o.replace(/[^0-9]/g, "")) - f,
            $(".renewValue").html(h.toLocaleString("en-US") + " ₫"));
        e = $(".eventPrice").attr("data-val");
        r = $(".eventPrice").attr("data-rate");
        (e || r) && (u = parseInt(o.replace(/[^0-9]/g, "")),
            c = r > 0 ? u - u * r / 100 : u - e,
            $(".eventValue").html(c.toLocaleString("en-US") + " ₫"));
        AddCart();
        quickOrder()
    });
    t();
    ...
    ;
sliderTestimonial_init = function () {
    var i = $("#jssor_testimonial").length, t, n;
    if (i) {
        t = {
            $AutoPlay: !0,
            $Loop: 0,
        ...
        n = new $JssorSlider$("jssor_testimonial", t);
        function i() {
